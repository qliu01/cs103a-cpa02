...
/* ************************
   ...
   ************************ */
// this route loads in the movies into the Movie collection
// or updates the movies if it is not a new collection
...
app.post('/movies/byActor',
    // show movies containing a specific actor
    async (req,res,next) => {
        try {
...
app.post('/movies/byYear',
    // show movies from a specific year
    async (req,res,next) => {
        try {
...
app.get('/movies/byYear/:year',
    // show movies from a specific year (specified via parameter)
    async (req,res,next) => {
...
app.post('/movies/byTitle',
    // show movies for a specific title
    async (req,res,next) => {
        try {
...
app.post('/movies/byGenre',
    // show movies from a specific genre
    async (req,res,next) => {
        try {
